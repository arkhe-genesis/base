...
pub async fn webhook_handler(
    ...
    // Need to convert to owned string for spawn
...
pub fn create_webhook_router(
    ...
    // Criamos um sub-router para /dlq que usa state = dlq
    let dlq_router = Router::new()
        .route("/", axum::routing::get(dlq_handler))
        .with_state(dlq);
    ...
    Router::new()
        ...
        .with_state(handler)
        .nest("/webhooks/polar/dlq", dlq_router)
}