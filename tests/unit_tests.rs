// tests/unit_tests.rs
//! Testes unitários para os módulos de Pix, Picnic e Royalties.

use arkhe::integrations::pix::{PixGateway, PixPaymentRequest, PixStatus, PixWebhookPayload};
    ...
    fn test_royalty_split_validation() {
        let splits = vec![
            ...
            RoyaltySplit {
                ...
                share: 0.3,
                orcid: None,
                eth_address: Some("0x456...".to_string()),
                pix_key: None,
            },
        ];
