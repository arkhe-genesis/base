...
from arkhe_autonomous_economic_agent_substrate_980.paxos_gateway import PaxosUSDGGateway, PaxosCredentials
...
@pytest.mark.asyncio
@patch('arkhe_autonomous_economic_agent_substrate_980.paxos_gateway.Web3.is_connected', return_value=True)
async def test_get_balances(mock_is_connected, mock_creds):
    with patch.object(PaxosUSDGGateway, 'get_balances', new_callable=AsyncMock) as mock:
        from arkhe_autonomous_economic_agent_substrate_980.paxos_gateway import PaxosBalance
